...
Original file is located at
    https://colab.research.google.com/drive/1lAguY70qPRAyLl_RU84HXgqBxZ9jt_FX
...
# Añadir clase Person del vocabulario example4
g.add((example4.Person, RDF.type, RDFS.Class))

# Añadir tipo adicional a Oscar como example4:Person
g.add((person.Oscar, RDF.type, example4.Person))

# Añadir propiedades como en el RDF de ejemplo
...
g.add((person.Oscar, foaf.email, Literal("ocorcho@mydomain.org", datatype=XSD.string)))
