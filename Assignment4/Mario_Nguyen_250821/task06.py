# -*- coding: utf-8 -*-
"""Kopie von Task06.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1bw8Wd7QWuGHUKu2JA09Q0-Am4Lvdzf3L
...
# TO DO
class_list = ["Person", "Professor", "AssociateProfessor", "FullProfessor", "InterimAssociateProfessor"]

for c in class_list:
    g.add((ontology[c], RDF.type, RDFS.Class))
    g.add((ontology[c], RDFS.label, Literal(c, datatype=XSD.string)))
...
for subclass, superclass in hierarchy:
    g.add((ontology[subclass], RDFS.subClassOf, ontology[superclass]))
